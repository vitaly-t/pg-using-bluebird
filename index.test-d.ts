...
expectType<void>(pgrm.on('error', (err, client) => err.stack))
expectType<void>(pgrm.on('connect', (client) => client.escapeLiteral('')))
expectType<void>(pgrm.on('acquire', (client) => client.escapeLiteral('')))
expectType<void>(pgrm.on('remove', (client) => client.escapeLiteral('')))
